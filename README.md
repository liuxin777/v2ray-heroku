...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/liuxin777/v2ray-heroku)
...
| 变量 | 默认值 | 说明 |
| :--- | :--- | :--- |
| `ID` | `e37f6f31-2662-49b0-b90e-667b53907e88` | VMess 用户主 ID，用于身份验证，为 UUID 格式 |
